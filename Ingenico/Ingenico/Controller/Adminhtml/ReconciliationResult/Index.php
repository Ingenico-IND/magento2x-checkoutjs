...
namespace Ingenico\Ingenico\Controller\Adminhtml\ReconciliationResult;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($orderIds as $orderId) {
            ...
            if ($this->isPaymentSuccessful($paymentResult)) {
                ...
                $orderSuccessStatus =  $config->getValue('payment/ingenicopayment/order_success_status');
    ...
    public function getOrderCollectionByDate($from, $to)
    {
        ...
        $collection->getSelect()
            ...
            ->where('sop.method = ?', "ingenicopayment");
