...
namespace Worldline\Worldline\Controller\Token;

use Magento\Framework\Controller\ResultFactory;
use Worldline\Worldline\Model\AdditionalConfigVars;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $response->setData($this->additionalConfigVars->getConfig()['payment']['Worldline']);
